...
export default function OptionsPage() {
	return (
		<div className="container-background-none" id="tinted-image">
			{/* /* ------------------logo-------------------------- */}
					...
					<Card style={{ width: "18rem" }}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								<p>
									Your Bid: Dinner after Concert with one of
									the stars
								</p>
							</Card.Text>
					...
					<Card style={{ width: "18rem" }}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								<p>
									Your Bid: Visit recording session with the
									star
								</p>
							</Card.Text>
					...
					<Card style={{ width: "18rem" }}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								<p>
									Your Bid: Private jet flight with the Band
									for their next concert in Chicago
								</p>
							</Card.Text>
							<Button variant="primary">More Details Here</Button>
						</Card.Body>
					...
					<Card style={{ width: "18rem" }}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								<p>Location: Austin</p>
								<p>
									Your Bid: Private music lesson with the Star
								</p>
							</Card.Text>
							<Button variant="primary">More Details Here</Button>
						</Card.Body>
					...
					<Card style={{ width: "18rem" }}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								<p>Location: Berlin</p>
								<p>
									Your Bid: Back stage pass at the concert and
									a private dinner with all girl Band
								</p>
							</Card.Text>
							<Button variant="primary">More Details Here</Button>
						</Card.Body>
					...
					<Card style={{ width: "18rem" }}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								<p>
									Your Bid: Back stage pass at the concert and
									a private visit to the tour bus
								</p>
							</Card.Text>
							<Button variant="primary">More Details Here</Button>
						</Card.Body>
					...
					<Card style={{ width: "18rem" }}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								<p>Location: Dublin</p>
								<p>
									Your Bid: A rivate visit to the tour the
									Band headquarters
								</p>
							</Card.Text>
							<Button variant="primary">More Details Here</Button>
					...
					<Card style={{ width: "18rem" }}>
						...
						<Card.Body>
							...
							<Card.Text>
								...
								<p>Location: Austin</p>
								<p>
									Take a Southern Rock Cruise with the Band
									with all day music, food and drinks.
								</p>
							</Card.Text>
							<Button variant="primary">More Details Here</Button>
						</Card.Body>
