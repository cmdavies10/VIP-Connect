		...
		<div class="container-background-none" id="tinted-image">
			...
			<Container>
				<div class="title-container">
					...
					<h1>You are all set to Meet the Band!</h1>
				</div>
				...
				<Card className="text-center">
					<Card.Body>
						<Card.Footer>
							<Card.Img
								variant="top"
								src="http://www.sandysclass.com/2017%20Websites/Janeck_Tieler/metallicaheader.jpg"
							/>
						</Card.Footer>
						<Card.Title>Metallica VIP Package</Card.Title>
						<Card.Text>
							Enjoy your experience and Thanks you for supporting
							"All Within My Hands"
						</Card.Text>
						<CardDeck>
							<Card>
								<Card.Img
									variant="top"
									src="https://abouttruckdriving.com/wp-content/uploads/2010/10/Google-directions.png"
								/>
								<Card.Body>
									<Card.Title>
										Metallica VIP Package
									</Card.Title>
									<Card.Text>
										<p>Live : 10/29/2020</p>
										<p>Location: New York</p>
										<p>
											Your Bid: Dinner after Concert with
											one of the stars
										</p>
										All exclusive experience a dinner with
										your favorite Band at the most elegant
										private dining rooms in Mayfair awarded
										a Michelin star. Proceeds will got to
										All Within My Hands to assist the lives
										of members of the communities who have
										supported the band for years.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
							...
							<Card>
								<Card.Img
									variant="top"
									src="http://qrcode.kaywa.com/img.php?s=8&d=http%3A%2F%2Fwww.heresjonny.com"
								/>
